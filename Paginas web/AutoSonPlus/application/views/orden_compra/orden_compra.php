            ...
            <div id="test-list" class="card" data-toggle="lists" data-options='{"valueNames": ["orders-correo", "orders-nombre", "orders-admin", "orders-grupo", "orders-status"],"page":10,"pagination":"true"}'>
              <div class="card-header">
                <div class="row align-items-center">
                  ...
                  <div class="col-auto">
                    <!-- Button -->
                    <a href="<?=base_url('orden_compra/orden_compra_alta')?>"class="btn btn-primary btn-sm">
                        ...
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              <a href="<?=base_url('orden_compra/orden_compra_actualizacion/'.$cotizacion->Id_compras)?>" class="dropdown-item">
                                Editar
                              </a>
                              <a href="<?=base_url('orden_compra/orden_compra_actualizacion/'.$cotizacion->Id_compras)?>" class="dropdown-item">
                                Eliminar
