        ...
        <div class="row justify-content-center">
            <div class="col-12 col-12 col-lg-12 col-xl-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <!-- Form -->
                        <?=form_open('orden_compra/orden_compra_alta/')?>
  <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="orden_compra_referencia">
                            <?=form_error('input_cliente')?>
                      </div>
                    </div>
                    <div class="col-12 col-md-6">
                      <div class="form-group">
                       <label>
                        ...
                        <input type="number" class="form-control" name="orden_compra_Total" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-12 col-md-6">
                      <div class="form-group">
                       <label>
                        ...
                        <input type="date" class="form-control" name="orden_compra_fecha"  >
                      </div>
					  ...
					  <div class="form-group">
                       <label>
                          Status
                            ...
                            <input type="text" class="form-control" name="orden_compra_estatus"  >
